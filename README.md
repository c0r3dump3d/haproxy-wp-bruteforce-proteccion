...
For example for a typical haproxy configuration in the frontend section you must to put:
        ...
        frontend  web_http
            ...
            [...]
            # Configuration stop Wordpress bruteforce attacks 
...
In the backend section the confguration is:
        ...
        backend webhttp
            ...
            [...]
            server php1 10.100.1.1:80 check 
            server php2 10.100.1.2:80 check 
